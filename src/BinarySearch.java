...
public class BinarySearch {
    ...
    public static void main(String[] args) {
        ...
        //File a = new File("data/tinyW.txt");
        //In in = new In( a );
        In in = new In ("http://algs4.cs.princeton.edu/11model/largeW.txt");
        ...
        //File b = new File("data/tinyT.txt");
        In in2 = new In ( "http://algs4.cs.princeton.edu/11model/largeT.txt" );
        while (!in2.isEmpty()) {
